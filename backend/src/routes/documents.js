...
router.get("/", async (req, res) => {
  try {
    ...
    console.log(
      "Total records with Legal_Form_ID=40:",
      diagnostic1.recordset[0].count
    );
    console.log(
      "Available regions for Legal_Form_ID=40:",
      diagnostic2.recordset
    );
    console.log(
      "Region distribution for Legal_Form_ID=40:",
      diagnostic3.recordset
    );
