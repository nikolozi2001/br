...
**git:** `main` `origin/main`-ს **8 commit-ით უსწრებს** — `git push origin main` გასაკეთებელია.
...
- **აპის პოლიტიკაში ექსპორტი არ არის ნახსენები.** 4.3.0-დან აპი ფაილებს მოწყობილობაზე ინახავს, iOS-ზე გრაფიკი **ფოტოებში** ხვდება. ტექსტი ჯერ კიდევ 27 ივლისისაა და ამაზე არაფერს ამბობს. სამართლებრივი ტექსტია — შესასწორებელია ორივე ასლში ერთდროულად.
