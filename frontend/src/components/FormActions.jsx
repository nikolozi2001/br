export function FormActions({ t, onReset, isLoading }) {
  return (
    <div className="flex justify-center w-full mt-4">
      <div className="inline-flex flex-col sm:flex-row w-full sm:w-auto">
        ...
        <button
          type="button"
          disabled={isLoading}
          className="flex items-center justify-center px-4 py-2 font-bold text-[#0080BE] border-y border-[#0080BE] hover:bg-[#0080BE] hover:text-white transition-colors cursor-pointer text-sm sm:text-base disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={() => window.stop()}
        >
          <svg
            className="w-4 h-4 mr-2"
