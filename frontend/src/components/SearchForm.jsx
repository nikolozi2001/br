    ...
    <div className="w-full bg-white">
      <div className="container mx-auto">
        <div className="max-w-[1920px] mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <h2 className="text-2xl font-medium mb-6 text-center sm:text-left">ეკონომიკური სტატისტიკის ძებნა</h2>
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
              />
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="text-lg font-medium">პიროვნული მისამართი</h3>
                <div className="space-y-3">
                  <input
                    type="text"
                    placeholder="რეგიონი"
                    value={formData.personalAddress.region}
                    onChange={(e) => handleInputChange(e, 'personalAddress', 'region')}
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) => handleInputChange(e, 'personalAddress', 'municipalityCity')}
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) => handleInputChange(e, 'personalAddress', 'address')}
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
                  />
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <input
                    ...
                    onChange={(e) => handleInputChange(e, 'legalAddress', 'region')}
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) => handleInputChange(e, 'legalAddress', 'municipalityCity')}
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
                  />
                  <input
                    type="text"
                    ...
                    onChange={(e) => handleInputChange(e, 'legalAddress', 'address')}
                    className="w-full px-4 py-2 border border-gray-300 rounded focus:border-[#0080BE] focus:outline-none"
                  />
                </div>
              </div>
            ...
            <div className="space-y-4">
              <h3 className="text-lg font-medium">ეკონომიკური საქმიანობა (NACE Rev.2)</h3>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  type="text"
